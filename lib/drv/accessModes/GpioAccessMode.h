	...
	class GpioAccessMode {
		...
		public:
			...
			enum {
				...
				IO_PORTC = 0x08,			// 0,1,2,3,4,5,x,x (analog pins)
				IO_PORTD = 0x0b,			// 0,1,2,3,4,5,6,7

				#elif defined(__AVR_ATmega1280__) || defined(__AVR_ATmega2560__)

				IO_PORTA = 0x02,			// 22,23,24,25,26,27,28,29
				IO_PORTB = 0x05,			// 53,52,51,50,10,11,12,13
				IO_PORTC = 0x08,			// 37,36,35,34,33,32,31,30
				IO_PORTD = 0x0b,			// 21,20,19,18,x,x,x,x
				IO_PORTE = 0x0e,			// 0,1,x,5,2,3,x,x
				IO_PORTF = 0x11,			// 0,1,2,3,4,5,6,7 (analog pins)
				IO_PORTG = 0x14,			// 41,40,39,x,x,4,x,x
