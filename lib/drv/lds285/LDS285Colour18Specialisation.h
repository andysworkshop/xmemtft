...
namespace lcd {
  ...
  template<class TAccessMode,class TPanelTraits>
  inline uint16_t LDS285Colour<COLOURS_18BIT,TAccessMode,TPanelTraits>::getInterfacePixelFormat() const {
    return 0x66;
  }
  ...
  template<class TAccessMode,class TPanelTraits>
  inline void LDS285Colour<COLOURS_18BIT,TAccessMode,TPanelTraits>::rawFlashTransfer(uint32_t data,uint32_t numPixels) const {
  ...
  template<class TAccessMode,class TPanelTraits>
  inline uint8_t LDS285Colour<COLOURS_18BIT,TAccessMode,TPanelTraits>::getBytesPerPixel() const {
    return 3;
  }
}
