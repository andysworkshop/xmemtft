...
/**
 * @file HX8352APortraitSpecialisation.h
 * @brief Specialisation of HX8352AOrientation for portrait mode.
 * @ingroup HX8352A
 */
...
namespace lcd {
	...
	template<class TAccessMode,class TPanelTraits>
	inline uint8_t HX8352AOrientation<PORTRAIT,TAccessMode,TPanelTraits>::getMemoryAccessControl() const {
	 ...
	 * @return The panel width (e.g. 480)
	 */

	template<class TAccessMode,class TPanelTraits>
	inline int16_t HX8352AOrientation<PORTRAIT,TAccessMode,TPanelTraits>::getWidth() const {
	...
	template<class TAccessMode,class TPanelTraits>
	inline int16_t HX8352AOrientation<PORTRAIT,TAccessMode,TPanelTraits>::getHeight() const {
	...
	template<class TAccessMode,class TPanelTraits>
	inline void HX8352AOrientation<PORTRAIT,TAccessMode,TPanelTraits>::setScrollPosition(int16_t scrollPosition) const {
