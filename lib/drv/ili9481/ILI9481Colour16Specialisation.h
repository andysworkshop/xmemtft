...
namespace lcd {
  ...
  template<class TAccessMode>
  inline void ILI9481Colour<COLOURS_16BIT,TAccessMode>::rawFlashTransfer(uint32_t buffer,uint32_t numPixels) const {
  ...
  template<class TAccessMode>
  inline uint8_t ILI9481Colour<COLOURS_16BIT,TAccessMode>::getBytesPerPixel() const {
    return 2;
  }
}
