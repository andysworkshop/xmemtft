...
namespace lcd {
  ...
  template<class TAccessMode,class TPanelTraits>
  inline uint16_t MC2PA8201Colour<COLOURS_24BIT,TAccessMode,TPanelTraits>::getInterfacePixelFormat() const {
    return 0x77;
  }
  ...
  template<class TAccessMode,class TPanelTraits>
  inline void MC2PA8201Colour<COLOURS_24BIT,TAccessMode,TPanelTraits>::rawFlashTransfer(uint32_t data,uint32_t numPixels) const {
  ...
  template<class TAccessMode,class TPanelTraits>
  inline uint8_t MC2PA8201Colour<COLOURS_24BIT,TAccessMode,TPanelTraits>::getBytesPerPixel() const {
    return 3;
  }
}
