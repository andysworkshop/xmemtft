...
namespace lcd {
  ...
  template<class TAccessMode,class TPanelTraits>
  inline uint16_t MC2PA8201Colour<COLOURS_16BIT,TAccessMode,TPanelTraits>::getInterfacePixelFormat() const {
    return 0x55;
  }
  ...
  template<class TAccessMode,class TPanelTraits>
  inline void MC2PA8201Colour<COLOURS_16BIT,TAccessMode,TPanelTraits>::rawFlashTransfer(uint32_t buffer,uint32_t numPixels) const {
  ...
  template<class TAccessMode,class TPanelTraits>
  inline uint8_t MC2PA8201Colour<COLOURS_16BIT,TAccessMode,TPanelTraits>::getBytesPerPixel() const {
    return 2;
  }
}
