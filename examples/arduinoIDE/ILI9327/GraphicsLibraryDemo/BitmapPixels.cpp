...
void _asmStub() {
  ...
  __asm volatile(
    ...
    "CloudPixels:              \n\t"
    ".incbin \"libraries/xmemtft/examples/ILI9327/GraphicsLibraryDemo/cloud100x100.bin\" \n\t"
    "CloudPixelsSize=.-CloudPixels  \n\t"
    
    ".balign 2 \n\t"

    "LogoPixels:\n\t"
    ".incbin \"libraries/xmemtft/examples/ILI9327/TrueType/logo.lzg\"\n\t"
    "LogoPixelsSize=.-LogoPixels\n\t"

    ".balign 2 \n\t"

    "GlobePixels:\n\t"
    ".incbin \"libraries/xmemtft/examples/ILI9327/GraphicsLibraryDemo/globe.lzg\" \n\t"
